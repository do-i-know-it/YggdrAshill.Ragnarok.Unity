...
namespace YggdrAshill.Ragnarok
{
    ...
    public sealed class CreateComponentInNewPrefabStatement : IComponentInjection, IStatement
    {
        ...
        private IInstantiation CreateInstantiation()
        {
            ...
            {
                return new CreateComponentInNewPrefab(prefab, injection, candidate, dontDestroyOnLoad);
            }

            return new CreateComponentInNewPrefab(prefab, null, candidate, dontDestroyOnLoad);
        }
